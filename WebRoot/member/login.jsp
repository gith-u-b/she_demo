...
<div class="toolbar box">
   <div class="toolbar-inner">
    <div class="fl " id="logincontent">
        ...
        <c:if test="${!empty user }">
        	 欢迎您: ${user.userName} &nbsp; <a href="<%=path %>/member/logout.jsp">退出登录</a>
        </c:if>
	</div>
    <div class="fr">
...
<form id="jvForm" action="<%=path %>/user_login.action" method="post">
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="5">	
                                ...
                                <tr>
                                  ...
                                  <td colspan="2"><input value="liuya" type="text" id="username" name="user.userName" class="input required"/></td>
                  </tr>
                                <tr>
                                  <td height="30" align="right">密　码：</td>
                                  <td colspan="2"><input type="password" id="password" value="admin" name="user.passWord" class="input required"/></td>
                                </tr>
                                <tr>
