                        ...
                        <table cellspacing="5" cellpadding="0" width="850" align="center" border="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input class="input2 required email" value="${user.email} " id="email" maxlength="30"  name="user.userEmail" type="text" /></td>
                                </tr>
                                <tr>
                                    <td align="right" width="187" height="30">&nbsp;</td>
                                ...
                                <tr>
                                    ...
                                    <td><input class="input2 required" id="passWord" type="password" name="user.passWord" /></td>
                                </tr>
                                <tr>
                                    <td align="right" width="187" height="30">&nbsp;</td>
